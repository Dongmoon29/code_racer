...
func (m *MockJudgeService) EvaluateCode(code string, language string, problem *model.Problem) (*types.EvaluationResult, error) {
...
func (m *MockJudgeService) WrapCodeWithTestCase(code string, languageID int, testCase string, problem *model.Problem) (string, error) {
	if languageID == 9999 {
...
func (m *MockJudgeService) EvaluateCodeWithRealtime(code string, language string, problem *model.Problem, matchID uuid.UUID, userID uuid.UUID) (*types.EvaluationResult, error) {

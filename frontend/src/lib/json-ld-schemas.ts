 ...
 *
 * This file contains TypeScript interfaces and utility functions for generating
 * structured data (JSON-LD) according to Schema.org specifications.
 * These schemas help search engines understand the content and improve SEO.
 *

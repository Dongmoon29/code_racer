...
const CodeEditor: React.FC<CodeEditorProps> = ({
  ...
  // Get editor container based on size
      ...
      {showToolbar && (
        <EditorToolbar>
          <ToolbarLeft>
            ...
            {vimMode && <ToolbarButton isActive>VIM</ToolbarButton>}
          </ToolbarLeft>
          <ToolbarRight>
            {readOnly && <ToolbarButton>READ ONLY</ToolbarButton>}
          </ToolbarRight>
        </EditorToolbar>
      )}
      ...
      {showStatusBar && (
        <StatusBar>
          <StatusLeft>
            <StatusItem>
              <span>Ln</span>
              <span>{viewRef.current?.state.selection.main.head || 0}</span>
            </StatusItem>
            <StatusItem>
              <span>Col</span>
              <span>{viewRef.current?.state.selection.main.head || 0}</span>
